...
import { exchangeCodeForTokens, getLinkedInUserInfo } from '@/lib/social/platforms/linkedin';
...
export default async function handler(
  ...
  try {
    ...
    // Clear OAuth cookie
    res.setHeader('Set-Cookie', 'linkedin_oauth_state=; Path=/; HttpOnly; Max-Age=0');

    return res.redirect('/admin/social-media/accounts?connected=linkedin');
  } catch (error) {
