...
const products = [
  // ===== COURSES =====
  {
    ...
    link: '/courses/success-mindset-masterclass',
    featured: true,
    product_type: 'course',
    digital: true,
    duration: '8 weeks',
  ...
  },
  {
    ...
    link: '/courses/business-growth-accelerator',
    featured: true,
    product_type: 'course',
    digital: true,
    duration: '12 weeks',
  ...
  },
  {
    ...
    link: '/courses/leadership-essentials',
    product_type: 'course',
    digital: true,
    duration: '6 weeks',
  ...
  // ===== EXPANDED MERCHANDISE =====
  {
    ...
    link: '/shop/success-2026-goal-planner',
    featured: true,
  ...
  },
  {
    ...
    category: 'Merchandise',
    subcategory: 'Journals & Planners',
    link: '/shop/leather-notebook-set',
    product_type: 'physical',
    digital: false,
    rating: 4.9,
    review_count: 1567,
